...
**Distributed microservices architecture** built as an upgraded version of a [monolithical books e-commerce platform](https://github.com/Abdellah-saim-mamoune1/shopping-platform) with multiple independent services communicating via REST, gRPC, and event-driven messaging.
